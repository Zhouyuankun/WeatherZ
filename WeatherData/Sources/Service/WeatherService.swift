...
public final class WeatherService {
    nonisolated(unsafe) public static let shared = WeatherService()
    ...
    public func loadCurrentWeather(lon: Double, lat: Double) async -> Result<CurrentWeatherResponse, Error> {
    ...
    public func loadForecastWeather(lon: Double, lat: Double) async -> Result<ForecastResponse, Error> {
    ...
    public func fetchCityCoordinate(city: String) async -> Result<[GeoAPIResponse], Error> {
    ...
    public func fetchCityName(latitude: Double, longitude: Double) async -> Result<[GeoAPIResponse], Error> {
    ...
    public func mockCurrentWeather() -> CurrentWeatherResponse {
        let fileUrl = Bundle.module.url(forResource: "current_weather", withExtension: "json")!
        let decoder = JSONDecoder()
        decoder.keyDecodingStrategy = .convertFromSnakeCase
        do {
    ...
    public func mockForecastWeather() -> ForecastResponse {
        let fileUrl = Bundle.module.url(forResource: "forecast_weather", withExtension: "json")!
        let decoder = JSONDecoder()
        decoder.keyDecodingStrategy = .convertFromSnakeCase
        do {
    ...
    private nonisolated(unsafe) let defaultCurrentWeatherResponse: CurrentWeatherResponse = {
    ...
    private nonisolated(unsafe) let defaultForecastWeatherResponse: ForecastResponse = {
        ForecastResponse(
            cod: "200",
            message: 0,
            cnt: 4,
